          ...
          <CardContent>
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full" type="button" onClick={() => alert("TODO: OAuth Google")}>
                {/* placeholder glyph */}<svg viewBox="0 0 533.5 544.3" className="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg"><path d="M533.5 278.4c0-17.4-1.6-34.1-4.7-50.4H272v95.3h147.3c-6.4 34.7-25.7 64-54.7 83.7v69.3h88.4c51.7-47.6 80.5-117.8 80.5-197.9z"/><path d="M272 544.3c73.5 0 135.2-24.3 180.3-66.1l-88.4-69.3c-24.5 16.4-55.9 26-91.9 26-70.7 0-130.6-47.7-152-111.8H29.7v70.2C74.4 486.3 166.5 544.3 272 544.3z"/><path d="M120 322.9c-10.3-30.7-10.3-64 0-94.7V158H29.7C-9.8 235.4-9.8 335.3 29.7 412.8l90.3-69.9z"/><path d="M272 107.7c39.9-.6 78.2 14 107.5 41.1l80.5-80.5C407 24.2 345.3 0 272 0 166.5 0 74.4 57.9 29.7 131.5l90.3 70.2C141.4 155.4 201.3 107.7 272 107.7z"/></svg>
