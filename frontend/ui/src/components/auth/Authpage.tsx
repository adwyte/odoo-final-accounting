...
const loginSchema = z.object({
  ...
  // keep boolean REQUIRED in the inferred type (avoid RHF mismatch)
        ...
        <Card className="shadow-xl border-slate-200 rounded-2xl">
          ...
          <CardContent>
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full" type="button" onClick={() => alert("TODO: OAuth Google")} aria-label="Continue with Google">
              ...
              <Button variant="outline" className="w-full" type="button" onClick={() => alert("TODO: OAuth GitHub")} aria-label="Continue with GitHub">
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <p className="text-xs text-muted-foreground text-center">
        By signing up, your role defaults to <strong>Contact</strong>. Admin can elevate to <strong>Invoicing User</strong> or <strong>Business Owner</strong> later.
      </p>
    </form>
  );
}
